...
* Fix: Don't hang on a locked keyring when reading credentials; time out after 3s and continue without remote devices ([mobilecli#408](https://github.com/mobile-next/mobilecli/pull/408)), thanks to [@EnglandLobster](https://github.com/EnglandLobster)
...
* Feat(iOS): Slider, picker, alert, list and navigation elements are kept in `mobile_list_elements_on_screen` ([mobilecli#440](https://github.com/mobile-next/mobilecli/pull/440))
* Feat(iOS): `mobile_get_foreground_app` reports the on-screen view controller as the activity ([mobilecli#405](https://github.com/mobile-next/mobilecli/pull/405))
* Feat(iOS): Screenshots and screen recording can run at the same time ([mobilecli#429](https://github.com/mobile-next/mobilecli/pull/429))
* Fix(iOS): Clipboard on simulators works on iOS 26.5, where `simctl pbcopy` silently left it empty ([mobilecli#425](https://github.com/mobile-next/mobilecli/pull/425))
...
* Perf(Android): Tap, long press, swipe, buttons and typing go through the embedded agent instead of `adb shell input`, which forked a JVM per call ([mobilecli#412](https://github.com/mobile-next/mobilecli/pull/412)), thanks to [@akexorcist](https://github.com/akexorcist)
* Fix(Android): `mobile_get_foreground_app` reports the real app name and focused activity, including on devices with more than one display ([mobilecli#403](https://github.com/mobile-next/mobilecli/pull/403), [mobilecli#423](https://github.com/mobile-next/mobilecli/pull/423)), thanks to [@akexorcist](https://github.com/akexorcist)
* Fix(Android): `mobile_list_elements_on_screen` is no longer stale after fast content changes, such as a Compose `LazyRow` loading ([mobilecli#439](https://github.com/mobile-next/mobilecli/pull/439))
* Fix(Android): Screenshots and recording work on Android 12 and 13 ([mobilecli#435](https://github.com/mobile-next/mobilecli/pull/435))
* Fix(Android): Apps and urls launch on the default display ([mobilecli#442](https://github.com/mobile-next/mobilecli/pull/442))
* Fix(Android): Agents are reachable when the adb server runs on another host ([mobilecli#434](https://github.com/mobile-next/mobilecli/pull/434))
...
* Feat: Click on element by `@ref` from `mobile_list_elements_on_screen` ([#429](https://github.com/mobile-next/mobile-mcp/pull/429))
* Feat: Text format for `mobile_list_elements_on_screen`, now the default, ~5x smaller than json ([#431](https://github.com/mobile-next/mobile-mcp/pull/431))
* Feat: Add geo location, clipboard and device logs tools ([#423](https://github.com/mobile-next/mobile-mcp/pull/423))
* Feat: Add `mobile_get_foreground_app` tool ([#420](https://github.com/mobile-next/mobile-mcp/pull/420))
* Feat: Scale screenshots natively via mobilecli, drop sips/imagemagick ([#418](https://github.com/mobile-next/mobile-mcp/pull/418))
* Feat: Agent Plugin packaging, mobile-automation skill, MCPB bundle and Smithery CI ([#416](https://github.com/mobile-next/mobile-mcp/pull/416), [#415](https://github.com/mobile-next/mobile-mcp/pull/415))
* Feat: Run device commands through a background daemon over a unix socket for a major performance boost ([mobilecli#384](https://github.com/mobile-next/mobilecli/pull/384))
* Feat: Dump Flutter UI via the Dart VM service with semantics and element types ([mobilecli#365](https://github.com/mobile-next/mobilecli/pull/365), [mobilecli#389](https://github.com/mobile-next/mobilecli/pull/389))
* Perf: Cache Robot per device id ([#430](https://github.com/mobile-next/mobile-mcp/pull/430))
* Fix: Keep ref, selected, checked and enabled on screen elements ([#421](https://github.com/mobile-next/mobile-mcp/pull/421))
* Fix: Validate install path, coordinates and mobilecli JSON output ([#425](https://github.com/mobile-next/mobile-mcp/pull/425))
...
* Chore: Upgrade bundled mobilecli from 1.0.0 to 1.0.9 ([#417](https://github.com/mobile-next/mobile-mcp/pull/417), [#428](https://github.com/mobile-next/mobile-mcp/pull/428))
...
* Feat(Android): Device Kit agent is now embedded, no APK install required ([mobilecli#387](https://github.com/mobile-next/mobilecli/pull/387))
* Perf(Android): Faster screenshots and view tree snapshots via on-device agent ([mobilecli#368](https://github.com/mobile-next/mobilecli/pull/368))
